...
%     set(handles.Tbx_servo_8,'String',servo(8));
    ...
    s1x= str2double(get(handles.Tbx_servo_1, 'string'));
    s2x= str2double(get(handles.Tbx_servo_2, 'string'));
    s3x= str2double(get(handles.Tbx_servo_3, 'string'));
    s4x= str2double(get(handles.Tbx_servo_4, 'string'));
    s5x= str2double(get(handles.Tbx_servo_5, 'string'));
    s6x= str2double(get(handles.Tbx_servo_6, 'string'));
    ...
    if velocidad <1.5
        mensaje='Volocidades menores que 1.5, no enviarán datos por el puerto serial. '
     ...
     mensaje='Solo está graficando. Elija un COM y luego Conectar para enviar movimientos'
     set(handles.Lbl_mensaje,'String',mensaje);
    end
